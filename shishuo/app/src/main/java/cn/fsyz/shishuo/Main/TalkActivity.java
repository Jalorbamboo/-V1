...
//用户发送讨论
public class TalkActivity extends BaseActivity implements EasyPermissions.PermissionCallbacks,BGASortableNinePhotoLayout.Delegate {
    ...
    private Handler handler = new Handler(){
        ...
        public void handleMessage(Message msg) {
            switch (msg.what){
                case PROCESS2:
                    progressDialog1 = new ProgressDialog(TalkActivity.this);
                            ...
                            public void done(List<Power> list, BmobException e) {
                                if (e==null){
                                    ...
                                    if (right.contentEquals("2")){
                                        ...
                                        TalkTitle talkTitle = new TalkTitle();
                                        talkTitle.setObjectId(getIntent().getStringExtra("id"));
                                        Talk p2 = new Talk();
                                        p2.setTalkTitle(talkTitle);
                                        p2.setContent(c);
                                        p2.setUser(bmobUser);
