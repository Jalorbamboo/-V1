...
public class SendActivity extends BaseActivity implements EasyPermissions.PermissionCallbacks,BGASortableNinePhotoLayout.Delegate {
    ...
    private Handler handler = new Handler(){
        ...
        public void handleMessage(Message msg) {
            switch (msg.what){
                case PROCESS2:
                    progressDialog1 = new ProgressDialog(SendActivity.this);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        title = findViewById(R.id.poet_title);
        bgm = findViewById(R.id.bgm_edit);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try {
                    ...
                    final String b = bgm.getText().toString();
                    if (c.contentEquals("")){
                        ShowToast("请输入内容");
                                    ...
                                    if (right.contentEquals("2")){
                                        ...
                                        p2.save(new SaveListener<String>() {
                                            ...
                                            public void done(String objectId,BmobException e) {
                                                if(e==null){
                                                    Log.e("tupianUrl",""+photourl);
                                                    if (photo_url.contentEquals("null")){
                                                        //Log.e("tag","没有照片");
                                                        ShowToast("发送成功");
                                                        handler.sendEmptyMessage(dismiss1);
                                                        finish();
                                                    }else if(photourl.size()==0){
                                                        ShowToast("发送成功");
                                                        handler.sendEmptyMessage(dismiss1);
                                                        finish();
                                                    }else{
            ...
            public void onSuccess(List<BmobFile> list, List<String> list1) {
                ...
                if(list1.size()==filePaths.length){
                    ...
                    String str1 = (String)list1.get(0);//获取第一行数据
                            ...
                            comment.setPhotoUrl(list1);
                            comment.setPhoto_url(str1);
