...
//广播站列表
public class BsenderOpenAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    //上下文
    Context mContext;
    //数据链
    private List<BsenderTitle> dataList = new ArrayList<>();
    //点击监听
    ...
    //加载数据
    public void addAllData(List<BsenderTitle> dataList) {
    ...
    public BsenderOpenAdapter(Context context) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType==TYPE_IMAGEVIEW){
            ...
            return new BsenderOpenAdapter.ViewViewHolder(view2);
            ...
            return new BsenderOpenAdapter.TextViewHolder(v);
        }
        return null;
    }
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, final int position) {
        BsenderTitle feedback = dataList.get(position);
        ...
        }else if (holder instanceof BsenderOpenAdapter.TextViewHolder){
            ((BsenderOpenAdapter.TextViewHolder) holder).id1.setText(feedback.getObjectId());
    ...
    public void setOnItemClickListener(BsenderOpenAdapter.OnItemClickListener listener) {
